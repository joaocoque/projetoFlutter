  ...
  Widget build(BuildContext context){
      ...
      child: RaisedButton(
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            SizedBox(width: 5),
            Text(' www.listacompras.com', style: TextStyle(color: Colors.white))
          ]
        ),
        onPressed: () {
          String url = 'https://www.listaCompras.com';
      ...
      child: RaisedButton(
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            SizedBox(width: 5),
            Text('  Compras no YouTube', style: TextStyle(color: Colors.white))
          ],
        ),
        onPressed: () {
          String url = 'https://www.youtube.com/channel/ListaCompras';
          canLaunch(url).then((status) {
            if (status) {
              launch(url);
            } else {
    ...
    return Layout.getContent(context, Center(
      child: ListView(
        shrinkWrap: true,
        children: <Widget>[
          Center(child: Text('ListaCompras', style: TextStyle(
            fontSize: 22,
            color: Layout.primary(),
